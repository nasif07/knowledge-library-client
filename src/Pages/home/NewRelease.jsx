    ...
    return (
        <>
            ...
            <div className="hero min-h-screen max-w-[1500px] px-16 mx-auto">
                <div className="flex lg:flex-row md:flex-col items-center justify-center gap-4">
                    <div className='flex-1'>
                        ...
                        <div className='flex gap-5 font-medium'>
                            <button className="w-[150px] border-2 rounded-lg bg-[#F99206] text-white">View All</button>
